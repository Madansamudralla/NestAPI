	...
	public enum UserType {
		...
		public String doLogin() {
			if (null == this.token) {
				...
				ConfigurationManager.getBundle().setProperty("token", results.get("token").getAsString());
				ConfigurationManager.getBundle().setProperty("emp_id", results.get("emp_id").getAsString());
				ConfigurationManager.getBundle().setProperty("first_name", results.get("first_name").getAsString());
				ConfigurationManager.getBundle().setProperty("last_name", results.get("last_name").getAsString());
				ConfigurationManager.getBundle().setProperty("job_title", results.get("job_title").getAsString());
				ConfigurationManager.getBundle().setProperty("location", results.get("location").getAsString());
