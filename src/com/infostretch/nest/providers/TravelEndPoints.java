...
public class TravelEndPoints {
	...
	public final static String GET_TRAVEL_ADMIN_LOC_EMPLOYEES =
			"/get-travel-admin-loc-employees";
	...
	public final static String GET_EMPLOYEE_DESIGNATION_LIST_DD =
			"/get-employee-designation-list-dd";
	public final static String GET_ALL_EMPLOYEE_LIST_EXPENSE =
			"/get-all-employee-list-for-expense";
	public final static String ADD_EDIT_BOOKING_DETAILS = "/addedit-booking-details";
	public final static String GET_BOOKING_DOCUMENTS = "/get-booking-documents";
	public final static String DELETE_BOOKING_DETAILS = "/delete-booking-details";
	public final static String GET_BOOKING_DETAILS = "/get-booking-details";
	public final static String GET_TRAVEL_REQUESTS_FOR_EMPLOYEE =
			"/get-travel-requests-for-employee";
	public final static String GET_MANAGERS_DD = "/get-managers-dd";
	public final static String APPROVE_REJECT_TRAVEL_REQUEST =
	...
	public final static String GET_TRAVEL_CATEGORIES = "/get-travel-categories";
	public final static String GET_ID_PROOF_ATTACHMENTS = "/get-id-proof-attachments";
