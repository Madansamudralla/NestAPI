...
public interface VisaEndPoints {
	...
	public final static String VISA_DELETE_VISA_TYPE= "/delete-visa-type";
	public final static String VISA_REQUEST_LIST_FOR_MANAGER= "/get-visa-request-list-for-manager";
	public final static String VISA_TRVL_LIST_FOR_ADMINS= "/get-visa-trvl-list-for-admins";
	public final static String VISA_DILIVERY_MANAGERS ="get-delivery-managers";
